...
// Toggle see more projects
function seeMoreProjects() {
  let moreProjects = document.querySelector(".read-more-projects");
  moreProjects.classList.toggle("visible");
}

let moreProjectsBtn = document.querySelector(".btn-toggle-projects");
moreProjectsBtn.addEventListener("click", seeMoreProjects);
